...
export default function VesselList() {
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Filter */}
      <div className="px-2.5 py-2 border-b border-border-dim flex-shrink-0">
        <input
          type="text"
      ...
      {/* Category tabs */}
      <div className="flex flex-wrap gap-1 px-2.5 py-1.5 border-b border-border-dim flex-shrink-0" role="tablist" aria-label="Vessel categories">
      ...
      {/* Sort buttons */}
      <div className="flex gap-1 px-2.5 py-1.5 border-b border-border-dim flex-shrink-0" role="group" aria-label="Sort vessels by">
        ...
        <span className="ml-auto text-[10px] text-text-dim font-data">{sorted.length}</span>
      </div>
      ...
      <div className="flex-1 overflow-y-auto" role="list">
        {sorted.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-32 text-text-dim text-[11px] gap-1">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" className="text-text-dim opacity-50">
